...
function program11(depth0,data) {
  ...
  return "\n                    <div class='sandbox_header'>\n                        <input class='submit' name='commit' type='button' value='Try it out!' />\n                        <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n                        <img class='response_throbber' style='display:none' />\n                    </div>\n                    ";}
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "_endpoint_list'></ul>\n";
  return buffer;}
...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "_endpoint_list' style='display:none'></ul>\n";
  return buffer;}
...
(function() {
  ...
  SwaggerUi = (function(_super) {
    ...
    SwaggerUi.prototype.render = function() {
      ...
      this.mainView = new MainView({
        model: this.api,
        el: $('#' + this.dom_id),
        showOperations: this.options.showOperations
      }).render();
      this.showMessage();
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.initialize = function(options) {
      ...
      return this.showOperations = options.showOperations;
    };
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.render = function() {
      ...
      this.model.showOperations = this.showOperations;
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        if (headerParams) {
          $(".request_headers", $(this.el)).show();
          $(".request_headers .block", $(this.el)).html("<pre>" + JSON.stringify(headerParams, null, "\t").replace(/\n/g, "<br>") + "</pre>");
        } else {
          $(".request_headers", $(this.el)).hide();
        }
        if (bodyParam) {
          $(".request_body", $(this.el)).show();
          $(".request_body .block", $(this.el)).html("<pre>" + bodyParam.replace(/\\r\\n/g, "<br>") + "</pre>");
        } else {
          $(".request_body", $(this.el)).hide();
        }
